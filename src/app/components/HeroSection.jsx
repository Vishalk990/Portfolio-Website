    ...
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          mb-6 lg:text-xl"
          >
            Hello, and welcome to my portfolio! My name is Vishal Kalita, and I am currently pursuing a Master of Computer Applications (MCA) at Christ Univeriisty, Bangalore.
          </p>
          <div>
            <Link
              href="/"
              className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-primary-500 to-blue-500 hover:bg-slate-200 text-white"
            >
              Hire Me
            </Link>
            <Link
